...
// import문을 사용하려면 index.html의 main.js 연결 구문에 type="module" 속성을 추가해야함!
...
const headerMenuEls = [...headerEl.querySelectorAll('ul.menu > li')] //...: 전개 연산자(얕은 복사)
...
mapEls.forEach(function(el) {
    ...
    h3El.addEventListener('click',function(){
        ...
        //toggle: add와 remove의 역할을 동시에 수행 가능
    })
})